...
module.exports = class Editor {
    ...
    static makeDummy(){
        ...
        var eliminado = new Habitacion("Fuiste eliminado", 3, narrativa1, "Fuiste eliminado ¿Deseas volver a jugar?", [], false, [])
        var cofreEscondido = new Cofre("Cofre detras de habitacion", 7, narrativa1, "Ves un lindo cofre", [], false, [puertaHs1,puertaHs1,puertaHs1,puertaHs1], true, 60, [escudo])
        var enemigoFuerte = new Enemigo("Bicho recien despierto", 6, narrativa1, "Despertaste a un bicho malo malo", [], false, [eliminado,eliminado,eliminado,eliminado], enemigoFuerte)
        ...
        var cofreOculto = new Cofre("Cofre escondido", 2, narrativa1, "Encuentras el tesoro del infeliz", [percepcion], true, [habitacionSombria,habitacionSombria,habitacionSombria,habitacionSombria], true, 20, [llave])
        var primerEnemigo = new Enemigo("Aventurero Asustado", 1, narrativa1, "El asustadiso hombre te reta", [], false, [habitacionSombria, cofreOculto, habitacionSombria, habitacionSombria], enemigoDebil)
        ...
        eliminado.consecuencias = [entrada]
